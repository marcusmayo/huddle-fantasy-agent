    ...
    for (const shortage of this.crosswalk().positionShortfalls) {
      ...
      for (const candidate of candidates) {
        ...
        additions.push({
          ...
          injuryStatus: candidate.injuryStatusKnown ? candidate.injuryStatus : null,
          injuryStatusKnown: candidate.injuryStatusKnown === true,
          injurySource: candidate.injuryStatusKnown ? 'yahoo-current-designation' : null,
          injuryObservedAt: candidate.injuryStatusKnown ? this.iso() : null,
          injurySeason: entry.config.provenance?.season || this.runtime.season,
