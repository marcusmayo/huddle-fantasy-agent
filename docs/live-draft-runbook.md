...
The [September 9 actual Yahoo mock attempt](yahoo-browser-acceptance-2026-09-09.md) failed before controller activation. Resolve the separate waiting-room tab explicitly, retain room-mismatch diagnostics, and prepare the full candidate pool before entry. Yahoo's first 100 rendered players and its “Your Turn” divider rows are not evidence of complete draft coverage. No new successful live acceptance is claimed.
